...
[`@aws-sdk/client-rekognition`](https://www.npmjs.com/package/@aws-sdk/client-rekognition/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rekognition@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N4tz7SnsDRiRG0SkLUTd37Jc251zLJbid4L4gIuAAwtnjC9h+AO8G8UjLi7+88yQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rekognition": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rekognition@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rekognition@3.957.0/index.min.mjs": "sha384-N4tz7SnsDRiRG0SkLUTd37Jc251zLJbid4L4gIuAAwtnjC9h+AO8G8UjLi7+88yQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rekognition/blob/refs/tags/3.957.0/LICENSE
```
